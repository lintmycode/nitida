export default class Life {
  ...
  draw() {
    ...
    // Pulse from blue to lime
    const pulse = (Math.sin(this.generation * 0.1)) // range: -1 to +1
    const blend = Math.abs(pulse) // range: 0 to 1

    const aliveColor = this.interpolateColor('#0c96ee', '#DDFF55', blend)
